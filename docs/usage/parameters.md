...
| `--barcodes`               | Path to barcodes.csv file for barcoding data data.                                                                                                                                                                                                                                                                                                                               |                                                                                    | ✅       |
| `--fiji_stitchcrop_script` | Path to script to use for FIJI Stitchcrop.                                                                                                                                                                                                                                                                                                                                       | `/home/florian/nf-pooled-cellpainting/assets/stitchcrop/stitch_crop.env_master.py` | ✅       |
| `--range_skip`             | Step number for subsampling images for segcheck.                                                                                                                                                                                                                                                                                                                                 | `2`                                                                                |          |
| `--cycle_metadata_name`    | What should the cycle metadata column be named? (Must align with cppipe cycle name!)                                                                                                                                                                                                                                                                                             | `Cycle`                                                                            |          |
...
Configuration options for the painting arm of the pipeline.

| Parameter                     | Description                                                   | Default               | Required |
| :---------------------------- | :------------------------------------------------------------ | :-------------------- | :------- |
| `--painting_channame`         | Channel name for nucleus staining for painting arm.           | `DNA`                 |          |
...
| `--painting_scalingstring`    | Scaling for images.                                           | `1`                   |          |
...
| Parameter                         | Description                                                                       | Default               | Required |
| :-------------------------------- | :-------------------------------------------------------------------------------- | :-------------------- | :------- |
| `--barcoding_channame`            | Channel name for nucleus staining for barcoding arm.                              | `DNA`                 |          |
| `--barcoding_illumapply_grouping` | What level to parallelize illumapply for barcoding arm. Options: `well`, `site`.  | `well`                |          |
...
| `--barcoding_scalingstring`       | Scaling for images.                                                               | `1.99`                |          |
